from matrix_necesary import ShapeError as ShapeError
from matrix_necesary import permutations as permutations
from matrix_necesary import parity as parity
...
class matrix(object):
    ...
    def __init__(self,elements,is_identity = False):
        """
        Declares the matrix with 2D-list elements
        """
